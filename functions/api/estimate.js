...
{"maker":"メーカー名（例:トヨタ/日産/ホンダ/レクサス/BMW等）","model":"車種名","size":"S/M/L/LL/3Lのいずれか","confidence":"high/medium/low"}
サイズ区分の基準:
S=コンパクトカー・軽自動車(ヤリス/フィット/ノート/アクア等)
M=セダン・ミドルSUV・ミニバン(プリウス/クラウン/セレナ/ヴォクシー等)
L=大型SUV・大型セダン(ランドクルーザー/RX/CX-80等)
LL=アルファードクラス・大型ミニバン
3L=ハイエース・輸入SUV・アメ車・超大型車
